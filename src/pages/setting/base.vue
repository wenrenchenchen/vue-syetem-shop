      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="注册与访问" name="first">
          ...
          <el-form-item label="注册类型">
            <el-radio-group v-model="form.reg_method" class="reg-type">
          ...
          <el-form-item label="强制密码复杂度">
            <el-checkbox-group v-model="form.password_encrypt" class="reg-type-group">
        ...
        <el-tab-pane label="上传设置" name="second">
          <el-form-item label="默认上传方式">
            <el-radio-group v-model="form.upload_method" class="reg-type">
