      ...
      <el-form-item label="自购返佣">
        <div>
          <el-radio-group v-model="form.brokerage_method">
            <el-radio label="hand" border style="width: 40%;">手动到账</el-radio>
            <el-radio label="wx" border style="width: 48%;">自动到微信零钱</el-radio>
          </el-radio-group>
...
const form = reactive({
  ...
  spread_banners: ["https://img-s.msn.cn/tenant/amp/entityid/AA1JRibR.img?w=768&h=512&m=6"],
  is_self_brokerage: 1,
  settlement_days: 7,
...
<style scoped>
/* 注册类型的单个按钮 */
:deep(.reg-type) .el-radio {
  width: 103px;
}

/* 强制密码复杂度按钮 */
.reg-type-group .el-checkbox {
  width: 103px;
}

:deep(.el-tabs__content) {
  padding-top: 16px; /* 给内容留些空间 */
  min-height: 300px; /* 视内容调节 */
}
:deep(.el-tabs__nav) {
  margin-bottom: 1px;
}
