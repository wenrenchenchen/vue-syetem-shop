...
<template>
    <el-card shadow="never" class="border-0">
        ...
        <FormDrawer ref="setRuleFormDrawerRef" title="权限配置" @submit="handleSetRuleSubmit">
            <el-tree-v2 node-key="id" :default-expanded-keys="defaultExpandedKeys" ref="elTreeRef" 
             :data="ruleList" :check-strictly="checkStrictly" :props="{ label: 'name', children: 'child' }"
